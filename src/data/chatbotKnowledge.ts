...
export const knowledgeBase: KnowledgeBaseItem[] = [
  // Geral
  {
    ...
    answer: 'O RecrutaRS é uma plataforma inteligente de recrutamento que conecta empresas a candidatos qualificados. Utilizamos testes comportamentais para garantir o melhor match entre perfil do candidato e cultura da empresa.',
    category: 'general',
  ...
  },
  {
    ...
    answer: 'Para **candidatos**, o RecrutaRS é 100% gratuito - você pode criar perfil, fazer o teste comportamental e se candidatar a vagas sem nenhum custo.\n\nPara **empresas**, oferecemos diferentes planos com funcionalidades variadas. Consulte nossa página de planos para mais detalhes.',
    category: 'general',
    contexts: ['guest', 'candidate', 'company'],
    priority: 8,
  },
  ...
  // Testes Comportamentais
  {
    ...
    keywords: ['comportamental', 'teste', 'perfil', 'psicológico'],
    answer: 'O teste comportamental é uma avaliação que identifica seu estilo de trabalho e comunicação. O Gauge-Pro avalia 5 dimensões principais:\n\n• **Dominância** - Como você lida com desafios\n• **Sociabilidade** - Como você influencia os outros\n• **Ritmo** - Como você lida com mudanças\n• **Conformidade** - Como você lida com regras\n• **Relacional** - Como você se relaciona\n\nO resultado ajuda a encontrar vagas alinhadas com seu perfil!',
    category: 'tests',
    contexts: ['guest', 'candidate', 'company'],
    priority: 10,
  },
  {
    id: 'behavioral-2',
    question: 'Quanto tempo demora o teste comportamental?',
    keywords: ['tempo', 'duração', 'demora', 'teste', 'comportamental', 'minutos'],
    answer: 'O teste comportamental leva em média **10 a 15 minutos** para ser completado. Não há respostas certas ou erradas - responda com sinceridade para obter resultados mais precisos.\n\n**Dica:** Faça o teste em um momento tranquilo, sem interrupções.',
    category: 'tests',
    contexts: ['guest', 'candidate'],
    priority: 9,
  },
  {
    id: 'behavioral-3',
    question: 'Posso refazer o teste comportamental?',
    keywords: ['refazer', 'repetir', 'novamente', 'teste', 'comportamental', 'resetar'],
    answer: 'Em geral, você pode refazer o teste comportamental após um período de 6 meses. Isso porque seu perfil comportamental tende a ser estável ao longo do tempo.\n\nSe acredita que houve algum erro ou mudança significativa, entre em contato com nosso suporte para avaliar seu caso.',
    category: 'tests',
    contexts: ['candidate'],
    priority: 8,
  },
...
export const initialSuggestions: Record<UserContext, ChatbotSuggestion[]> = {
  ...
  candidate: [
    ...
    { id: 'sug-5', type: 'quick_reply', label: 'Sobre o teste', value: 'O que é o teste comportamental?' },
  ...
  company: [
    ...
    { id: 'sug-9', type: 'quick_reply', label: 'Sobre o teste', value: 'O que é o teste comportamental?' },
  ],
  admin: [
