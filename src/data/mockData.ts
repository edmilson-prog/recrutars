...
export const mockUsers: User[] = [
  { id: 'admin-1', name: 'Ana Silva', email: 'admin@recrutars.com', type: 'admin', createdAt: '2024-01-15', roleId: 'role-super-admin', status: 'active', lastAccessAt: '2026-02-03T10:30:00', groupIds: [] },
  { id: 'company-1', name: 'Tech Solutions', email: 'rh@techsolutions.com', type: 'company', createdAt: '2024-02-10', roleId: 'role-owner', status: 'active', lastAccessAt: '2026-02-03T09:15:00', groupIds: [] },
  { id: 'company-2', name: 'Inovação Digital', email: 'rh@inovacaodigital.com', type: 'company', createdAt: '2024-03-05', roleId: 'role-manager', status: 'active', lastAccessAt: '2026-02-01T14:30:00', groupIds: [] },
  { id: 'company-3', name: 'StartUp Brasil', email: 'contato@startupbrasil.com', type: 'company', createdAt: '2024-04-20', roleId: 'role-recruiter', status: 'active', lastAccessAt: '2026-01-28T11:00:00', groupIds: [] },
  { id: 'candidate-1', name: 'João Santos', email: 'joao.santos@email.com', type: 'candidate', createdAt: '2024-03-10', roleId: undefined, status: 'active', lastAccessAt: '2026-02-03T08:45:00', groupIds: [] },
  { id: 'candidate-2', name: 'Maria Oliveira', email: 'maria.oliveira@email.com', type: 'candidate', createdAt: '2024-03-15', roleId: undefined, status: 'active', lastAccessAt: '2026-02-02T16:20:00', groupIds: [] },
  { id: 'candidate-3', name: 'Pedro Costa', email: 'pedro.costa@email.com', type: 'candidate', createdAt: '2024-04-01', roleId: undefined, status: 'inactive', lastAccessAt: '2026-01-15T10:00:00', groupIds: [] },
  { id: 'candidate-4', name: 'Carla Mendes', email: 'carla.mendes@email.com', type: 'candidate', createdAt: '2024-04-15', roleId: undefined, status: 'active', lastAccessAt: '2026-02-01T13:10:00', groupIds: [] },
  { id: 'candidate-5', name: 'Lucas Ferreira', email: 'lucas.ferreira@email.com', type: 'candidate', createdAt: '2024-05-01', roleId: undefined, status: 'pending', lastAccessAt: undefined, groupIds: [] },
];
...
export const mockCompanies: Company[] = [
  {
    ...
    plan: 'Seleção Inteligente' as CompanyPlanType,
  ...
  },
  {
    ...
    totalCandidates: 84,
    status: 'active' as CompanyStatus,
    plan: 'Essencial Empresas' as CompanyPlanType,
  ...
  // PRD-020: Novas empresas para testar paginação e filtros
  {
    ...
    totalCandidates: 213,
    status: 'active' as CompanyStatus,
    plan: 'Recrutamento Premium' as CompanyPlanType,
